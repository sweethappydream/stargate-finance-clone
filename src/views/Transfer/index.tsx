    ...
    >
      <div className="w-[545px] bg-[#31333C] border border-white/20 rounded-[30px] overflow-hidden relative">
        ...
        <div className="px-[33px] py-9">
          ...
          <button
            className="bg-primary mt-7 w-full duration-200 font-poppins text-white py-4 px-5 justify-center rounded-xl flex items-center gap-2"
            onClick={connect}
            disabled={connected}
          >
            <svg
            ...
            {!connected ? "Connect Wallet" : "Trasfer"}
          </button>
        </div>
        {/** Body --End-- */}
      </div>
